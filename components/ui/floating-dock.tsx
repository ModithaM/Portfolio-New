  ...
  return (
    <div className={cn('relative block md:hidden', className)}>
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 shadow-lg dark:bg-neutral-800"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'mx-auto hidden h-16 items-end gap-4 rounded-2xl bg-gray-50 px-4 pb-3 shadow-lg md:flex dark:bg-neutral-900',
        className,
      )}
    >
      {items.map((item) => (
